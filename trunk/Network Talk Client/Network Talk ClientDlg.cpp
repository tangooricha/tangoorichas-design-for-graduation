// Network Talk ClientDlg.cpp : implementation file
//
...
BOOL CNetworkTalkClientDlg::OnInitDialog()
{
	...
	AfxBeginThread(ThreadListenToServer,0);
	
	return TRUE;  // return TRUE  unless you set the focus to a control
}

void CNetworkTalkClientDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
UINT CNetworkTalkClientDlg::ThreadListenToServer(LPVOID pParam)
{
	printf("!!!");
	return TRUE;
}
